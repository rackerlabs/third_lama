...
stored as textfile
location 's3://hackathon070617/onegb/customer/';
...
fields terminated by '|'
stored as textfile
location 's3://hackathon070617/onegb/lineitem/';
...
fields terminated by '|'
stored as textfile
location 's3://hackathon070617/onegb/nation/';
...
fields terminated by '|'
stored as textfile
location 's3://hackathon070617/onegb/orders/';
...
fields terminated by '|'
stored as textfile
location 's3://hackathon070617/onegb/part/';
...
fields terminated by '|'
stored as textfile
location 's3://hackathon070617/onegb/partsupp/';
...
fields terminated by '|'
stored as textfile
location 's3://hackathon070617/onegb/region/';
...
fields terminated by '|'
stored as textfile
location 's3://hackathon070617/onegb/supplier/';
